...
replace (
	// Use 0.34.x so controller-runtime and openshift/client-go get runtime.ApplyConfiguration,
	// resourcelock.NewWithLabels, and structured-merge-diff v6 compatibility.
	...
	// Pin kubelet to 0.33.2 so RTE v0.21.6 (which calls GetSize_()) matches podresources API.
